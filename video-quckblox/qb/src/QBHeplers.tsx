...
export const createUserSession = async (
  loginData: LoginData
): Promise<ParamsConnect> => {
  return new Promise((resolve, reject) => {
    QB.createSession(
      loginData,
      async (errorCreateSession: any, session: any) => {
...
export const connectToChatServer = async (
  ...
  return new Promise((resolve, reject) => {
    QB.chat.connect(
      paramsConnect,
      async (errorConnect: any, resultConnect: any) => {
        if (errorConnect) {
          reject(errorConnect);
        } else {
...
export const createUserAction = async (
  ...
  let resultCreateUserAction: UserCreationStatus =
    UserCreationStatus.UserCreated;
  createAppSession()
    .then(async () => {
