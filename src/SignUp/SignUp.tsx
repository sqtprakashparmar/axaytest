...
const SignUp: React.FC<SignUpProps> = ({
  ...
  useEffect(() => {
    setValidInputValues(
      !validValue.userName.isNotValid &&
        validValue.userName.isTouched &&
        !validValue.fullName.isNotValid &&
        validValue.fullName.isTouched &&
        !validValue.userPassword.isNotValid &&
        validValue.userPassword.isTouched
    );
  }, [validValue]);
          ...
          <Box component="form" onSubmit={submitForm} sx={{ mt: 1 }}>
            ...
            <TextField
              ...
              onChange={(e) => {
                ...
                validValueUserName.isNotValid = !nicknameValidate(
                  e.target.value
                );
            ...
            <TextField
              ...
              onChange={(e) => {
                ...
                validValueFullName.isNotValid = !fullNameValidate(
                  e.target.value
                );
            ...
            <TextField
              ...
              onChange={(e) => {
                ...
                validValueUserPassword.isNotValid = !passwordValidate(
                  e.target.value
                );
                setValidValue({
                  ...validValue,
                  userPassword: validValueUserPassword,
                });
              }}
              onFocus={() =>
                setValidValue({
            ...
            {errorMessage || !isOnline ? (
              ...
              >
                <Alert severity="error">
                  {!isOnline ? "No connection." : errorMessage}
                </Alert>
              </Grid>
            ) : null}
          </Box>
